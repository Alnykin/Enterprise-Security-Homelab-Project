...
## Architecture
This environment consists of seven virtual machines, each fulfilling a specific role within the network. Core services include Active Directory for centralized authentication and identity management, a jumpbox for controlled access to internal systems, Wazuh for security monitoring and log analysis, and a MailHog server for internal email functionality and testing.
